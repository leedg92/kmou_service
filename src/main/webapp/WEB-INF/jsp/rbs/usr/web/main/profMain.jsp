			...
			<div class="m_comm_L">
				...
				<ul class="m_comm_news" id="commu-home" role="tabpanel" aria-labelledby="commu-home-tab">
					<li>
						...
						<a href="/web/board/view.do?mId=39&amp;NTT_SN=10348693" title="게시물 제목" class="">「부산광역시 청년정책조정위원회」 위원 공개 모집 안내</a>
						<p>-</p>
						<span>2024-07-30</span>
					</li>
					<li>
						<strong class="comm-tag d-inline-block me-1 notice">공지사항</strong>
						<a href="/web/board/view.do?mId=39&amp;NTT_SN=10348665" title="게시물 제목" class="">세계 대학생 건강총회 개최 안내</a>
						<p>-</p>
						<span>2024-07-30</span>
					</li>
					<li>
