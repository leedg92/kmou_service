...
<script type="text/javascript">
	...
	function renderStudPlanList(data){
		...
		if(totalPageCount > pageSize){			
			...
			pageCon += '<li class="page-item page-prev"><a href="javascript:getAffairCommitteeList(' + prevPageNo + ');" class="page-link" title="prev"><span class="blind">prev</span><img src="<c:out value="../${contextPath}${imgPath}/arr_bottom_gray.png"/>" alt="이전으로 화살표" /></a></li>';
		...
		for(var pageNo = firstPageNoOnPageList; pageNo <= lastPageNoOnPageList; pageNo++){
  		...
  		if(totalPageCount > pageSize){
			...
			pageCon += '<li class="page-item page-next"><a href="javascript:getAffairCommitteeList(' + nextPageNo + ');" class="page-link" title="next"><span class="blind">next</span><img src="<c:out value="../${contextPath}${imgPath}/arr_bottom_gray.png"/>" alt="다음으로 화살표" /></a></li>';
